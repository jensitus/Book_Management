...
public class BookGUI extends JFrame {
	...
	/** 
	 * Zuweisung Inhalt und Form der einzelnen Komponenten, die
	 * dann im North-Panel ausgegeben werden.
	 * Mit der Möglichkeit zur Suche nach dem Buchtitel
	 */
	...
	/** 
	 * Zuweisung Inhalt und Form der einzelnen Komponenten, die
	 * dann im East-Panel ausgegeben werden.
	 * Felder für die Ausgabe, Bearbeitung und Neuerfassung einzelner
	 * Bücher
	 */
	...
	private void initComponentsEast() {
		...
		publicationDateLabel.setFont(new Font(labelFont, labelStyle, labelSize));
		...
		String[] format = {"", "Taschenbuch", "Gebundene Ausgabe", "Hoerbuch", "elektronisch", "unbekannt"};
		for (int i = 0; i < format.length; i++) {
			formatCombo.addItem(format[i]);			
		}
		
		shortDescriptionLabel = new JLabel("Kurzbeschreibung: ");
		shortDescriptionLabel.setFont(new Font(labelFont, labelStyle, labelSize));
	...
	/** 
	 * Zuweisung Inhalt und Form der einzelnen Komponenten, die
	 * dann im West-Panel ausgegeben werden.
	 */
	
	private void initComponentsWest() {
		// Initailisierung der Büchertabelle. Nachdem auvh on anderes
	...
	/**
	 * Initialisierung der Büchertablle
	 */
	
	public JTable createBookTable() {
			
		try {
			//Herstellung der Datenbank-Verbindung
	...
	/**
	 * Der Inhalt aller Tabellenfelder im WestPanel wird zurückgesetzt
	 */
	public void resetTableWest() {
